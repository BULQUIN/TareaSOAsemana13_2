package pe.edu.utp.usuarios.service.impl;
...
import pe.edu.utp.usuarios.converter.UsuarioConverter;
...
import pe.edu.utp.usuarios.exception.NoDataFoundException;
import pe.edu.utp.usuarios.exception.ValidateServiceException;
import pe.edu.utp.usuarios.repository.UsuarioRepository;
import pe.edu.utp.usuarios.security.JwtService;
import pe.edu.utp.usuarios.service.UsuarioService;
import pe.edu.utp.usuarios.validator.UsuarioValidator;
...
public class UsuarioServiceImpl implements UsuarioService{
	...
	public Usuario update(Usuario usuario) {
		try {
			...
			registro.setRol(usuario.getRol().toString());
